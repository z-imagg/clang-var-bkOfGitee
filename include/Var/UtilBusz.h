 ...
 */
   ...
   */
  static bool get_func_of_stmt(const Stmt* stmt, const FunctionDecl* & funcDecl_/*出参*/, CompoundStmt*& compoundStmt_/*出参*/,SourceLocation& funcBodyLBraceLoc_/*出参*/,SourceLocation& funcBodyRBraceLoc_/*出参*/,  CompilerInstance& CI,  ASTContext *Ctx);
};
